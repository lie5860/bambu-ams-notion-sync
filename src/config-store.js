...
const DEFAULTS = {
  ...
  BAMBU_UID_FIELDS: "tray_uuid,tag_uid",
  NOTION_TOKEN: "",
  ...
  NOTION_TASK_FILAMENT_COLOR_DATABASE_NAME: "颜色映射",
  NOTION_AMS_UID_PROP: "Tray UUID",
  NOTION_COLOR_PROP: "颜色",
  NOTION_COLOR_LIST_PROP: "颜色列表",
  NOTION_COLOR_TYPE_PROP: "颜色类型",
  NOTION_COLOR_ALIAS_PROP: "颜色别名",
  NOTION_TAG_UID_PROP: "",
  NOTION_TRAY_UUID_PROP: "",
